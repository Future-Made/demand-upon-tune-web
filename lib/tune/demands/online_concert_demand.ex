defmodule Tune.Demands.OnlineConcertDemand do
  ...
  def changeset(online_concert_demand, attrs) do
    ...
    |> cast(attrs, [:willing_to_pay_min, :willing_to_pay_min, :willing_to_pay_max, :have_slow_internet, :will_support_causes, :charitable_percentage, :demand_as_multipass, :demand_on_air_months, :note_to_artist, :can_offer_help, :user_id])
    |> validate_required([:willing_to_pay_min, :willing_to_pay_min, :willing_to_pay_max, :demand_on_air_months, :note_to_artist, :can_offer_help, :user_id])
  end
end
