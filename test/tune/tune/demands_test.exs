defmodule Tune.DemandsTest do
  ...
  describe "online_concert_demands" do
    ...
    test "create_online_concert_demand/1 with valid data creates a online_concert_demand" do
      assert {:ok, %OnlineConcertDemand{} = online_concert_demand} =
               Demands.create_online_concert_demand(@valid_attrs)
      ...
      assert online_concert_demand.supported_causes == []
    ...
    test "update_online_concert_demand/2 with valid data updates the online_concert_demand" do
      ...
      assert {:ok, %OnlineConcertDemand{} = online_concert_demand} =
               Demands.update_online_concert_demand(online_concert_demand, @update_attrs)
    ...
    test "update_online_concert_demand/2 with invalid data returns error changeset" do
      ...
      assert {:error, %Ecto.Changeset{}} =
               Demands.update_online_concert_demand(online_concert_demand, @invalid_attrs)
    ...
    test "delete_online_concert_demand/1 deletes the online_concert_demand" do
      ...
      assert {:ok, %OnlineConcertDemand{}} =
               Demands.delete_online_concert_demand(online_concert_demand)

      assert_raise Ecto.NoResultsError, fn ->
        Demands.get_online_concert_demand!(online_concert_demand.id)
      end
    end
