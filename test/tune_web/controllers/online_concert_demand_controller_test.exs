defmodule TuneWeb.OnlineConcertDemandControllerTest do
  ...
  describe "create online_concert_demand" do
    test "redirects to show when data is valid", %{conn: conn} do
      conn =
        post(conn, Routes.online_concert_demand_path(conn, :create),
          online_concert_demand: @create_attrs
        )
    ...
    test "renders errors when data is invalid", %{conn: conn} do
      conn =
        post(conn, Routes.online_concert_demand_path(conn, :create),
          online_concert_demand: @invalid_attrs
        )
  ...
  describe "edit online_concert_demand" do
    ...
    test "renders form for editing chosen online_concert_demand", %{
      conn: conn,
  ...
  describe "update online_concert_demand" do
    ...
    test "redirects when data is valid", %{
      ...
      conn =
        put(conn, Routes.online_concert_demand_path(conn, :update, online_concert_demand),
          online_concert_demand: @update_attrs
        )

      assert redirected_to(conn) ==
               Routes.online_concert_demand_path(conn, :show, online_concert_demand)
  ...
  describe "delete online_concert_demand" do
    ...
    test "deletes chosen online_concert_demand", %{
      conn: conn,
      online_concert_demand: online_concert_demand
    } do
